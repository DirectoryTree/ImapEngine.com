...
const variantStyles = {
  primary:
    'rounded-full bg-pink-600 py-2 px-4 text-sm font-semibold text-white hover:bg-pink-700 focus:outline-hidden focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-300/50 active:bg-pink-800',
  secondary:
